...
function Sidebar() {
  ...
  return (
    <>
      ...
      <nav
        className={`fixed top-0 right-0 z-40 h-screen w-80 transform border-l border-zinc-400 bg-slate-100 px-8 py-4 shadow transition-transform duration-300 dark:border-zinc-700 dark:bg-zinc-800 ${
